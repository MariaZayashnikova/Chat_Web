...
import { fetchUserSettings, getTopicsFromDB, clearErrors } from '../../../actions'
import NavBar from './NavBar/NavBar'
import User from './User/User'
import GetDataFromDB from '../../services/getDataFromDB'
import './Operator-page.css'

function OperatorPage({ user, settingsUser, fetchUserSettings, getTopicsFromDB, clearErrors, error }) {
...
const mapDispatchToProps = { fetchUserSettings, getTopicsFromDB, clearErrors }
